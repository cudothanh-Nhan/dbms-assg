                ...
                case 'Tất cả':
                    return (
                        <tr>
                            ...
                            <td className="total-money">{Intl.NumberFormat().format(totalPrice(order[1]?.vehicles, Math.ceil(calDuration(order[1]?.startTime, order[1]?.endTime) / FEE_INTERVAL)))} VNĐ</td>
                        </tr>
                    );
            }
        });
